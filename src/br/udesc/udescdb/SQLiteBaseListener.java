...
public class SQLiteBaseListener implements SQLiteListener {
    ...
    private Queue<String> tiposColunas = new LinkedList<>();
    private Queue<String> nomesColunas = new LinkedList<>();
    private Queue<String> literaisColunas = new LinkedList<>();

    public Comando getComando() {
        if (comando.getTipo().equals(Comando.CREATE)) {
            while (!nomesColunas.isEmpty()) {
                Coluna coluna = new Coluna();
                coluna.setNome(nomesColunas.poll());
                String s = tiposColunas.poll();
        ...
        }else if(comando.getTipo().equals(Comando.INSERT)){
            while(!nomesColunas.isEmpty()){
                Coluna coluna = new Coluna();
                coluna.setNome(nomesColunas.poll());
                coluna.setLiteral(literaisColunas.poll());
                comando.addColuna(coluna);
    ...
    public void enterInsert_stmt(SQLiteParser.Insert_stmtContext ctx) {
        ...
        comando.setTipo(Comando.INSERT);
    }
    ...
    public void enterLiteral_value(SQLiteParser.Literal_valueContext ctx) {
        ...
        literaisColunas.add(ctx.getText());
       // coluna.setLiteral(ctx.getText());
    ...
    public void enterDatabase_name(SQLiteParser.Database_nameContext ctx) {
        comando.setNomeBanco(ctx.getText());
    }
